...
router.post('/investor/post', userController.CreateInvestorAccount);
router.get('/investor', userController.getAllInvestors);
router.put('/investor/:investorId', userController.EditInvestorAccount);
router.post('/investor/:investorId', userController.DeleteInvestor);


/**Department account */

router.post('/department/post', userController.CreateDepartment);
router.get('/department', userController.GetDepartments);
router.put('/department/:depId', userController.EditDepartment);
